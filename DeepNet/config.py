...
data_df = os.path.join(
    "DeepNet/HumBugDB", "data", "metadata", "neurips_2021_zenodo_0_0_1.csv"
)
# data_df = os.path.join(os.path.pardir, 'data', 'metadata', 'db_10_06_21_inc_false_positives.csv')
data_dir = os.path.join("DeepNet/HumBugDB", "data", "audio")
plot_dir = os.path.join("DeepNet", "outputs", "plots")
model_dir = os.path.join(
    "DeepNet", "outputs", "models"
...
dir_out_MED = os.path.join("DeepNet", "outputs", "features", "MED")
# sub-directory for mosquito species classification
dir_out_MSC = os.path.join("DeepNet", "outputs", "features", "MSC")
rate = 8000
win_size = 30
step_size = 5
n_feat = 128
